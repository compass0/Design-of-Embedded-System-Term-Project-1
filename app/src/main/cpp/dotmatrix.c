...
Java_com_example_PuyoPuzzle_MainActivityForServer_DotWrite (JNIEnv *jenv, jobject self, jint data){
    int fd, i;
...
JNIEXPORT void JNICALL
Java_com_example_PuyoPuzzle_MainActivityForClient_DotWrite (JNIEnv *jenv, jobject self, jint data){
    int fd, i;
