 ...
 */
JNIEXPORT void JNICALL Java_com_example_PuyoPuzzle_MainActivityForServer_SSegmentWrite
...
JNIEXPORT void JNICALL Java_com_example_PuyoPuzzle_MainActivityForClient_SSegmentWrite
        (JNIEnv *jenv, jobject self, jint data){
    int fd;
    unsigned char bytevalues[4];
    unsigned char ret;
